...
-- Started on 2013-12-15 22:51:56
...
ALTER TABLE public.assemblies OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.assemblies_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.company OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.company_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.contact_types OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.contact_types_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.customer OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.customer_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.customer_type OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.customer_type_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.employees OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.employees_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.estimate_types OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.estimate_types_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.item_codes OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.item_codes_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_call_notes OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_call_notes_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_change_orders OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_change_orders_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_contacts OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_contacts_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_costings OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_costings_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_documents OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_documents_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_estimates OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_estimates_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_service_types OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_service_types_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_site OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_site_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_statuses OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_statuses_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_tasks OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.job_tasks_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.lead_source OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.lead_source_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.product_colors OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.product_colors_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.product_types OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.product_types_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.roof_types OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.roof_types_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.schema_migrations OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.service_types OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.service_types_id_seq OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.task_types OWNER TO kirmnagawyavgf;
...
ALTER TABLE public.task_types_id_seq OWNER TO kirmnagawyavgf;
...
--
-- TOC entry 2233 (class 0 OID 16953)
-- Dependencies: 216
...
--
-- TOC entry 2235 (class 0 OID 16964)
-- Dependencies: 218
...
--
-- TOC entry 2219 (class 0 OID 16830)
-- Dependencies: 202
...
1	Contractor	2013-12-16 02:45:09.092054	2013-12-16 02:45:09.092054
2	Owner	2013-12-16 02:45:23.398872	2013-12-16 02:45:23.398872
\.
...
SELECT pg_catalog.setval('contact_types_id_seq', 2, true);


--
-- TOC entry 2189 (class 0 OID 16681)
-- Dependencies: 172
...
--
-- TOC entry 2191 (class 0 OID 16697)
-- Dependencies: 174
...
--
-- TOC entry 2193 (class 0 OID 16706)
-- Dependencies: 176
...
--
-- TOC entry 2195 (class 0 OID 16714)
-- Dependencies: 178
...
2	Inspect	30.00%	2013-12-13 19:33:53.328482	2013-12-13 19:33:53.328482
\.
...
--
-- TOC entry 2197 (class 0 OID 16722)
-- Dependencies: 180
...
1	BTS1	BOOTS 1 1-2"	EA	10.00	5.20	\N	\N	\N	2013-12-13 19:33:22.606725	2013-12-13 19:33:22.606725
...
SELECT pg_catalog.setval('item_codes_id_seq', 2, true);


--
-- TOC entry 2221 (class 0 OID 16838)
-- Dependencies: 204
...
--
-- TOC entry 2225 (class 0 OID 16854)
-- Dependencies: 208
...
--
-- TOC entry 2227 (class 0 OID 16865)
-- Dependencies: 210
...
SELECT pg_catalog.setval('job_contacts_id_seq', 1, true);


--
-- TOC entry 2231 (class 0 OID 16887)
-- Dependencies: 214
...
--
-- TOC entry 2229 (class 0 OID 16876)
-- Dependencies: 212
...
SELECT pg_catalog.setval('job_estimates_id_seq', 1, true);


--
-- TOC entry 2201 (class 0 OID 16740)
-- Dependencies: 184
...
SELECT pg_catalog.setval('job_service_types_id_seq', 3, true);


--
-- TOC entry 2203 (class 0 OID 16750)
-- Dependencies: 186
...
--
-- TOC entry 2205 (class 0 OID 16772)
-- Dependencies: 188
...
--
-- TOC entry 2223 (class 0 OID 16846)
-- Dependencies: 206
...
--
-- TOC entry 2207 (class 0 OID 16780)
-- Dependencies: 190
...
--
-- TOC entry 2209 (class 0 OID 16789)
-- Dependencies: 192
...
1	Black	2013-12-13 19:32:57.995317	2013-12-13 19:32:57.995317
...
--
-- TOC entry 2211 (class 0 OID 16797)
-- Dependencies: 194
...
--
-- TOC entry 2213 (class 0 OID 16805)
-- Dependencies: 196
...
--
-- TOC entry 2187 (class 0 OID 16401)
-- Dependencies: 170
...
--
-- TOC entry 2215 (class 0 OID 16813)
-- Dependencies: 198
...
--
-- TOC entry 2217 (class 0 OID 16822)
-- Dependencies: 200
...
--
-- TOC entry 2074 (class 2606 OID 16921)
...
--
-- TOC entry 2077 (class 2606 OID 16936)
...
--
-- TOC entry 2079 (class 2606 OID 16946)
...
--
-- TOC entry 2070 (class 2606 OID 16901)
...
--
-- TOC entry 2072 (class 2606 OID 16911)
...
--
-- TOC entry 2075 (class 2606 OID 16926)
...
--
-- TOC entry 2076 (class 2606 OID 16931)
...
--
-- TOC entry 2071 (class 2606 OID 16906)
...
--
-- TOC entry 2069 (class 2606 OID 16896)
...
--
-- TOC entry 2073 (class 2606 OID 16916)
...
--
-- TOC entry 2078 (class 2606 OID 16941)
...
-- Completed on 2013-12-15 22:51:59
